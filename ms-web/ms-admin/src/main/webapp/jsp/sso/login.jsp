...
<head>
    ...
    <link href="${basePath}/resources/xp-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/xp-admin/plugins/checkbix/css/checkbix.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/xp-admin/css/login.css" rel="stylesheet"/>
</head>
<body>
<div id="login-window">
...
<script src="${basePath}/resources/xp-admin/plugins/checkbix/js/checkbix.min.js"></script>
<script>var BASE_PATH = '${basePath}';</script>
<script>var BACK_URL = GetQueryString("callbackURL");
...
<script src="${basePath}/resources/xp-admin/js/login.js"></script>
<script>
