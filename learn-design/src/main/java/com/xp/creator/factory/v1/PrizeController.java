  ...
  public AwardRes awardToUser(AwardReq req) {
    ...
    try {
      ...
      if (req.getAwardType() == 1) {
        ...
        CouponResult couponResult = couponService
            .sendCoupon(req.getUId(), req.getAwardNumber(), req.getBizId());
        ...
        vipCardService.sendCard(bindMobileNumber, req.getAwardNumber());
        awardRes = new AwardRes("0000", "发放成功");
      }
