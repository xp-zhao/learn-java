...
public interface InstantiationAwareBeanPostProcessor extends BeanPostProcessor {
   ...
   *
   * <p>This is the ideal callback for performing field injection on the given bean instance. See
   * Spring's own {@link
   * org.learn.spring.beans.factory.annotation.AutowiredAnnotationBeanPostProcessor} for a typical
   * example.
   *
