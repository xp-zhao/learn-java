package java.org.learn.spring.core.convert.support;
...
import java.org.learn.spring.core.convert.converter.GenericConverter.ConvertiblePair;
...
public class GenericConversionService implements ConversionService, ConverterRegistry {
  ...
  public void addConverter(Converter<?, ?> converter) {
    ...
    for (GenericConverter.ConvertiblePair convertibleType :
        converterAdapter.getConvertibleTypes()) {
  ...
  public void addConverterFactory(ConverterFactory<?, ?> converterFactory) {
    ...
    for (GenericConverter.ConvertiblePair convertibleType :
        converterFactoryAdapter.getConvertibleTypes()) {
