...
/**
 * Created by xp-zhao on 2018/10/15.
 */
...
//	@Override
	public Class<?> jiazaiClass(String name) throws ClassNotFoundException {
	...
	public static void main(String[] args) throws Exception{
		Class clazz = new SimpleClassLoader("D:\\code\\github\\learn-java\\learn-test\\src\\main\\java\\com\\xp\\classloader").jiazaiClass("ClassLoaderAttachment");
		//0xCOFFBABE
