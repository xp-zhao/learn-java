...
//	@ResponseBody
	public String helloWorld(String username, String password,HttpServletRequest request,HttpSession session,HttpServletResponse response) throws IOException
	{
		return "index";
...
//		return result;
	...
	{
		User user = SSOUtil.getLoginUser(request.getSession().getId());
		return user;
