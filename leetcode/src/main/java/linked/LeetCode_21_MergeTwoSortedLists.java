 ...
 *
 * 示例： 输入：1->2->4, 1->3->4 输出：1->1->2->3->4->4 Created by xp-zhao on 2018/12/1.
 */
...
//    print(node1);
    ListNode node2 = mergeTwoLists_loop1(node1_1, node2_1);
    print(node2);
  }
  ...
  /**
   * @Description: 合并有序链表，循环-优化
   * @Param:
   * @return:
   * @Author: zhaoxp
   * @Date: 2019/5/11
   */
  public static ListNode mergeTwoLists_loop1(ListNode l1, ListNode l2) {
