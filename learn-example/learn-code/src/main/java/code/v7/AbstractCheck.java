 ...
 */
@Slf4j
public abstract class AbstractCheck<T extends IKey> implements ICheckStrategy {
  public void checkData(String filePathA, String filePathB) throws IOException {
    // 从文件中读取数据
